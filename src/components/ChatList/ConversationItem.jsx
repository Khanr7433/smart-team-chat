...
const ConversationItem = ({ conversation, isDesktopSidebar = false }) => {
      ...
      >
        ...
        {conversation.unreadCount > 0 && (
          <div className="flex-shrink-0 ml-2">
            <div className="bg-blue-500 text-white text-xs rounded-full min-w-[18px] h-5 flex items-center justify-center px-1.5 font-medium">
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between mb-1 lg:mb-2">
          ...
          <span className="text-xs lg:text-sm text-gray-500 flex-shrink-0 ml-2 lg:ml-3">
            {formatTimestamp(conversation.timestamp)}
          </span>
        </div>
      ...
      {conversation.unreadCount > 0 && (
        <div className="flex-shrink-0 ml-2 lg:ml-3">
          <div className="bg-blue-500 text-white text-xs lg:text-sm rounded-full min-w-[20px] lg:min-w-[24px] h-5 lg:h-6 flex items-center justify-center px-1.5 lg:px-2 font-medium shadow-sm">
            {conversation.unreadCount > 99 ? '99+' : conversation.unreadCount}
          </div>
        </div>
      )}
